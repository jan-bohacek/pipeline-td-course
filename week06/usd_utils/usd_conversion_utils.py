...
def batch_convert_assets(assets_dir):
    ...
    for file in os.listdir(assets_dir):
        if file.endswith(".glb"):
            ...
            gltf_node.parm("assetfolder").set(os.path.join(assets_dir, "tex"))
            ...
            usd_rop_lop.parm("execute").pressButton()

            print(f"Asset < {asset_name} > successfully converted!")
...
if __name__ == "__main__":
    ...
    batch_convert_assets(input_folder)